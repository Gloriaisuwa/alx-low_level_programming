 ...
 * @e_indent: pointer to an array containing the ELF class
 */
void print_class(unsigned char *e_ident)
{
	printf(" class:				");
 ...
 * @e_ident: pointer to an array containg the ELF version
 */
void print_version(unsigned char *e_ident)
{
	printf(" Version:				%d",
...
/**
 * print_type - [rints the type of an ELF header
 * @e_type: the ELF type
